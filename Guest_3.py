...
class guest_3:
    ...
    def Show(self,data):
        ...
        try:
            print("trye düştü")
            kelime = supabase.table("Missions").select("MissionId,MissionName,MissionExplanation,MissionDate,MissionTime,MissionRemember,MissionMusic").eq("MissionId",data[0]).execute().data
            result = [
                (
                    item["MissionId"],
                    item["MissionName"],
                    item["MissionExplanation"],
                    item["MissionDate"],
                    item["MissionTime"],
                    item["MissionRemember"],
                    item["MissionMusic"]
                )
                for item in kelime
            ]
            self.text = result
            #[(1, 'Kediyi besle', 'mamayla besle', '2025-12-30', '13:40', '13:30', 'Davul sesi')]
            print(result)
        ...
        self.gorevadi2 = tk.CTkLabel(self.app,text=self.text[0][1])
        ...
        self.gorevaciklama2 = tk.CTkLabel(self.app,text=self.text[0][2])
        ...
        self.gorevdate2 = tk.CTkLabel(self.app,text=self.text[0][3])
        ...
        self.gorevzamani2 = tk.CTkLabel(self.app,text=self.text[0][4])
        ...
        self.gorevvoice2 = tk.CTkLabel(self.app,text=self.text[0][3])
